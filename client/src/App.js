...
const levels = [
  ...
  { title: 'tunel-23', image: 'tunel-23.jpg', ranking: [{ name: 'Alex', time: 600, date: new Date() }, { name: 'Pepe', time: 300, date: new Date() }], items: [{ name: 'Kenny', top: 0.5, left: 0.5, image: 'kenny.png', found: false }, { name: 'Peter Griffin', top: 0.1, left: 0.1, image: 'peter.png', found: false }, { name: 'Zoidberg', top: 0.2, left: 0.2, image: 'zoidberg.png', found: false }] }
]
